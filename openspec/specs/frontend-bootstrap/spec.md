...
Arranque real de Inertia v2 + React 19 + TypeScript estricto + Tailwind 4 sobre Laravel 13, sirviendo al menos una página de punta a punta (CSR; sin SSR ni dominios de negocio).
